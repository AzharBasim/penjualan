...
<html lang="en">
  ...
  <head>
    ...
    <style>
        /* Posisikan kalender di tengah */
        #calendar-wrapper {
            display: flex;
            justify-content: center;
            align-items: center;
            height: 50vh; /* Sesuaikan tinggi kalender sesuai keinginan */
        }

        /* Pisahkan card dari sidebar */
        .card {
            margin-top: 10px;
        }
    </style>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand navbar-dark bg-dark static-top">
      ...
      <a class="navbar-brand mr-1" href="<?php echo base_url().'administrator/cekuser'?>">Mitra Jaya Manufacture</a>
          ...
          <div class="row">
            ...
            <div class="col-xl-3 col-sm-6 mb-3">
              <div class="card text-white bg-danger o-hidden h-100">
                ...
                <a class="card-footer text-white clearfix small z-1" href="<?php echo base_url().'admin/produk'?>">
                  <span class="float-left">View Details</span>
                  <span class="float-right">
                    <i class="fas fa-angle-right"></i>
                  </span>
