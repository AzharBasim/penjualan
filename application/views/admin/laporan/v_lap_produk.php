...
$nomor=1;
    ...
    $group=$d['kategori_nama'];
        ...
        <tr>
                ...
                <td style="vertical-align:center;text-align:center;"><?php echo $d['produk_satuan']; ?></td>
                <td style="vertical-align:center;padding-right:5px;text-align:right;"><?php echo 'Rp '.number_format($d['produk_harjul']); ?></td>
