...
class M_grafik extends CI_Model{
	function statistik_stok(){
        $query = $this->db->query("SELECT kategori_nama,SUM(produk_stok) AS tot_stok FROM tbl_produk JOIN tbl_kategori ON produk_kategori_id=kategori_id GROUP BY kategori_nama");
